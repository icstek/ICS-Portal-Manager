    ...
    <div className="space-y-4">
      ...
      {items.length > 0 && (
        <div className="grid grid-cols-12 gap-2 px-1">
          ...
          <div className="col-span-12 md:col-span-7"><Label className="text-xs text-muted-foreground">Description</Label></div>
          ...
          <div className="col-span-3 md:col-span-1"><Label className="text-xs text-muted-foreground">Total</Label></div>
